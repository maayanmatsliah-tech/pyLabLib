...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "sources": [
            "Z:\\Users\\ashkari\\Code\\v1\\pylablib\\devices\\Andor\\utils.pyx"
        ]
    },
...
#define __pyx_n_u_AT_QueueBuffer __pyx_string_tab[2]
#define __pyx_n_u_AT_WaitBuffer __pyx_string_tab[3]
#define __pyx_n_u_Hndl __pyx_string_tab[4]
...
#define __pyx_n_u_copyframes __pyx_string_tab[8]
#define __pyx_n_u_dst __pyx_string_tab[9]
#define __pyx_n_u_esize __pyx_string_tab[10]
#define __pyx_n_u_func __pyx_string_tab[11]
#define __pyx_n_u_hbuffers __pyx_string_tab[12]
#define __pyx_n_u_is_coroutine __pyx_string_tab[13]
#define __pyx_n_u_items __pyx_string_tab[14]
#define __pyx_n_u_looper __pyx_string_tab[15]
#define __pyx_n_u_looping __pyx_string_tab[16]
...
#define __pyx_n_u_nbuff __pyx_string_tab[20]
#define __pyx_n_u_ncpy __pyx_string_tab[21]
#define __pyx_n_u_nread __pyx_string_tab[22]
#define __pyx_n_u_off __pyx_string_tab[23]
#define __pyx_n_u_pop __pyx_string_tab[24]
#define __pyx_n_u_pylablib_devices_Andor_utils __pyx_string_tab[25]
#define __pyx_n_u_qualname __pyx_string_tab[26]
#define __pyx_n_u_queued __pyx_string_tab[27]
...
#define __pyx_n_u_start __pyx_string_tab[32]
#define __pyx_n_u_test __pyx_string_tab[33]
#define __pyx_n_u_values __pyx_string_tab[34]
#define __pyx_kp_b_iso88591_1F_5_e4wa __pyx_string_tab[35]
#define __pyx_kp_b_iso88591_A_wauF_9F_P_N2C1_1 __pyx_string_tab[36]
...
/* "pylablib/devices/Andor/utils.pyx":7
 * ctypedef int (*pAT_QueueBuffer)(int Hndl, void *Ptr, int PtrSize) noexcept nogil
 * 
 * @cython.cdivision(True)             # <<<<<<<<<<<<<<
...
static PyMethodDef __pyx_mdef_8pylablib_7devices_5Andor_5utils_1looper = {"looper", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_8pylablib_7devices_5Andor_5utils_1looper, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_8pylablib_7devices_5Andor_5utils_1looper(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_Hndl,&__pyx_mstate_global->__pyx_n_u_nbuff,&__pyx_mstate_global->__pyx_n_u_hbuffers,&__pyx_mstate_global->__pyx_n_u_esize,&__pyx_mstate_global->__pyx_n_u_queued,&__pyx_mstate_global->__pyx_n_u_looping,&__pyx_mstate_global->__pyx_n_u_nread,&__pyx_mstate_global->__pyx_n_u_AT_WaitBuffer,&__pyx_mstate_global->__pyx_n_u_AT_QueueBuffer,0};
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "looper", 0) < (0)) __PYX_ERR(0, 25, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 9; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("looper", 1, 9, 9, i); __PYX_ERR(0, 25, __pyx_L3_error) }
      }
    ...
    __pyx_v_Hndl = __Pyx_PyLong_As_int(values[0]); if (unlikely((__pyx_v_Hndl == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 25, __pyx_L3_error)
    __pyx_v_nbuff = __Pyx_PyLong_As_unsigned_int(values[1]); if (unlikely((__pyx_v_nbuff == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 25, __pyx_L3_error)
    __pyx_v_hbuffers = __Pyx_PyLong_As_size_t(values[2]); if (unlikely((__pyx_v_hbuffers == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 25, __pyx_L3_error)
    __pyx_v_esize = __Pyx_PyLong_As_int(values[3]); if (unlikely((__pyx_v_esize == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 25, __pyx_L3_error)
    __pyx_v_queued = __Pyx_PyLong_As_int(values[4]); if (unlikely((__pyx_v_queued == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 25, __pyx_L3_error)
    __pyx_v_looping = __Pyx_PyLong_As_size_t(values[5]); if (unlikely((__pyx_v_looping == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 25, __pyx_L3_error)
    __pyx_v_nread = __Pyx_PyLong_As_size_t(values[6]); if (unlikely((__pyx_v_nread == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 25, __pyx_L3_error)
    __pyx_v_AT_WaitBuffer = __Pyx_PyLong_As_size_t(values[7]); if (unlikely((__pyx_v_AT_WaitBuffer == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 26, __pyx_L3_error)
    __pyx_v_AT_QueueBuffer = __Pyx_PyLong_As_size_t(values[8]); if (unlikely((__pyx_v_AT_QueueBuffer == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 26, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("looper", 1, 9, 9, __pyx_nargs); __PYX_ERR(0, 25, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("pylablib.devices.Andor.utils.looper", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_8pylablib_7devices_5Andor_5utils_looper(__pyx_self, __pyx_v_Hndl, __pyx_v_nbuff, __pyx_v_hbuffers, __pyx_v_esize, __pyx_v_queued, __pyx_v_looping, __pyx_v_nread, __pyx_v_AT_WaitBuffer, __pyx_v_AT_QueueBuffer);
...
static PyObject *__pyx_pf_8pylablib_7devices_5Andor_5utils_looper(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_Hndl, unsigned int __pyx_v_nbuff, size_t __pyx_v_hbuffers, int __pyx_v_esize, int __pyx_v_queued, size_t __pyx_v_looping, size_t __pyx_v_nread, size_t __pyx_v_AT_WaitBuffer, size_t __pyx_v_AT_QueueBuffer) {
  ...
  /* "pylablib/devices/Andor/utils.pyx":27
 * def looper(int Hndl, unsigned nbuff, size_t hbuffers, int esize, int queued, size_t looping, size_t nread,
 *                     size_t AT_WaitBuffer, size_t AT_QueueBuffer):
 *     cdef int result=0             # <<<<<<<<<<<<<<
 *     with nogil:
...
*/
  ...
  /* "pylablib/devices/Andor/utils.pyx":28
 *                     size_t AT_WaitBuffer, size_t AT_QueueBuffer):
 *     cdef int result=0
 *     with nogil:             # <<<<<<<<<<<<<<
 *         result=clooper(Hndl,nbuff,<void **>hbuffers,esize,queued,<int *>looping,<unsigned *>nread,
...
*/
  {
      ...
      /*try:*/ {
        ...
        /* "pylablib/devices/Andor/utils.pyx":29
 *     cdef int result=0
 *     with nogil:
 *         result=clooper(Hndl,nbuff,<void **>hbuffers,esize,queued,<int *>looping,<unsigned *>nread,             # <<<<<<<<<<<<<<
 *                     <pAT_WaitBuffer>AT_WaitBuffer,<pAT_QueueBuffer>AT_QueueBuffer)
 *     return result
*/
        __pyx_t_1 = __pyx_f_8pylablib_7devices_5Andor_5utils_clooper(__pyx_v_Hndl, __pyx_v_nbuff, ((void **)__pyx_v_hbuffers), __pyx_v_esize, __pyx_v_queued, ((int *)__pyx_v_looping), ((unsigned int *)__pyx_v_nread), ((__pyx_t_8pylablib_7devices_5Andor_5utils_pAT_WaitBuffer)__pyx_v_AT_WaitBuffer), ((__pyx_t_8pylablib_7devices_5Andor_5utils_pAT_QueueBuffer)__pyx_v_AT_QueueBuffer)); if (unlikely(__pyx_t_1 == ((int)-1) && __Pyx_ErrOccurredWithGIL())) __PYX_ERR(0, 29, __pyx_L4_error)
...
*/
  ...
  /* "pylablib/devices/Andor/utils.pyx":31
 *         result=clooper(Hndl,nbuff,<void **>hbuffers,esize,queued,<int *>looping,<unsigned *>nread,
 *                     <pAT_WaitBuffer>AT_WaitBuffer,<pAT_QueueBuffer>AT_QueueBuffer)
 *     return result             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  __pyx_t_2 = __Pyx_PyLong_From_int(__pyx_v_result); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 31, __pyx_L1_error)
...
/* "pylablib/devices/Andor/utils.pyx":34
 * 
 * 
...
static int __pyx_f_8pylablib_7devices_5Andor_5utils_ccopyframes(unsigned int __pyx_v_nbuff, char **__pyx_v_hbuffers, unsigned int __pyx_v_size, unsigned int __pyx_v_start, unsigned int __pyx_v_ncpy, unsigned int __pyx_v_off, char *__pyx_v_dst) {
  ...
  /* "pylablib/devices/Andor/utils.pyx":35
 * 
 * cdef int ccopyframes(unsigned nbuff, char **hbuffers, unsigned size, unsigned start, unsigned ncpy, unsigned off, char *dst) nogil:
 *     cdef unsigned i=0             # <<<<<<<<<<<<<<
 *     for i in range(ncpy):
...
*/
  ...
  /* "pylablib/devices/Andor/utils.pyx":36
 * cdef int ccopyframes(unsigned nbuff, char **hbuffers, unsigned size, unsigned start, unsigned ncpy, unsigned off, char *dst) nogil:
 *     cdef unsigned i=0
 *     for i in range(ncpy):             # <<<<<<<<<<<<<<
 *         memcpy(dst,hbuffers[(start+i)%nbuff]+off,size)
 *         dst+=size
*/
  __pyx_t_1 = __pyx_v_ncpy;
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;

    /* "pylablib/devices/Andor/utils.pyx":37
 *     cdef unsigned i=0
 *     for i in range(ncpy):
 *         memcpy(dst,hbuffers[(start+i)%nbuff]+off,size)             # <<<<<<<<<<<<<<
 *         dst+=size
 *     return 0
*/
    __pyx_t_4 = (__pyx_v_start + __pyx_v_i);
    if (unlikely(__pyx_v_nbuff == 0)) {
      PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
      PyErr_SetString(PyExc_ZeroDivisionError, "integer division or modulo by zero");
      __Pyx_PyGILState_Release(__pyx_gilstate_save);
      __PYX_ERR(0, 37, __pyx_L1_error)
    }
    (void)(memcpy(__pyx_v_dst, ((__pyx_v_hbuffers[(__pyx_t_4 % __pyx_v_nbuff)]) + __pyx_v_off), __pyx_v_size));

    /* "pylablib/devices/Andor/utils.pyx":38
 *     for i in range(ncpy):
 *         memcpy(dst,hbuffers[(start+i)%nbuff]+off,size)
 *         dst+=size             # <<<<<<<<<<<<<<
 *     return 0
...
*/
  ...
  /* "pylablib/devices/Andor/utils.pyx":39
 *         memcpy(dst,hbuffers[(start+i)%nbuff]+off,size)
 *         dst+=size
 *     return 0             # <<<<<<<<<<<<<<
 * 
...
*/
  ...
  __Pyx_AddTraceback("pylablib.devices.Andor.utils.ccopyframes", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __Pyx_PyGILState_Release(__pyx_gilstate_save);
  __pyx_L0:;
  return __pyx_r;
...
/* "pylablib/devices/Andor/utils.pyx":41
 *     return 0
 * 
 * def copyframes(unsigned nbuff, size_t hbuffers, unsigned size, unsigned start, unsigned ncpy, unsigned off, size_t dst):             # <<<<<<<<<<<<<<
 *     with nogil:
...
/* Python wrapper */
static PyObject *__pyx_pw_8pylablib_7devices_5Andor_5utils_3copyframes(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
static PyMethodDef __pyx_mdef_8pylablib_7devices_5Andor_5utils_3copyframes = {"copyframes", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_8pylablib_7devices_5Andor_5utils_3copyframes, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_8pylablib_7devices_5Andor_5utils_3copyframes(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("copyframes (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  __pyx_nargs = PyTuple_GET_SIZE(__pyx_args);
  #else
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_nbuff,&__pyx_mstate_global->__pyx_n_u_hbuffers,&__pyx_mstate_global->__pyx_n_u_size,&__pyx_mstate_global->__pyx_n_u_start,&__pyx_mstate_global->__pyx_n_u_ncpy,&__pyx_mstate_global->__pyx_n_u_off,&__pyx_mstate_global->__pyx_n_u_dst,0};
    const Py_ssize_t __pyx_kwds_len = (__pyx_kwds) ? __Pyx_NumKwargs_FASTCALL(__pyx_kwds) : 0;
    ...
    if (__pyx_kwds_len > 0) {
      switch (__pyx_nargs) {
        case  7:
        values[6] = __Pyx_ArgRef_FASTCALL(__pyx_args, 6);
        if (!CYTHON_ASSUME_SAFE_MACROS && unlikely(!values[6])) __PYX_ERR(0, 41, __pyx_L3_error)
        CYTHON_FALLTHROUGH;
        case  6:
        values[5] = __Pyx_ArgRef_FASTCALL(__pyx_args, 5);
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "copyframes", 0) < (0)) __PYX_ERR(0, 41, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 7; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("copyframes", 1, 7, 7, i); __PYX_ERR(0, 41, __pyx_L3_error) }
      }
    ...
    __pyx_v_nbuff = __Pyx_PyLong_As_unsigned_int(values[0]); if (unlikely((__pyx_v_nbuff == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 41, __pyx_L3_error)
    __pyx_v_hbuffers = __Pyx_PyLong_As_size_t(values[1]); if (unlikely((__pyx_v_hbuffers == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 41, __pyx_L3_error)
    __pyx_v_size = __Pyx_PyLong_As_unsigned_int(values[2]); if (unlikely((__pyx_v_size == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 41, __pyx_L3_error)
    __pyx_v_start = __Pyx_PyLong_As_unsigned_int(values[3]); if (unlikely((__pyx_v_start == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 41, __pyx_L3_error)
    __pyx_v_ncpy = __Pyx_PyLong_As_unsigned_int(values[4]); if (unlikely((__pyx_v_ncpy == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 41, __pyx_L3_error)
    __pyx_v_off = __Pyx_PyLong_As_unsigned_int(values[5]); if (unlikely((__pyx_v_off == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 41, __pyx_L3_error)
    __pyx_v_dst = __Pyx_PyLong_As_size_t(values[6]); if (unlikely((__pyx_v_dst == (size_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 41, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("copyframes", 1, 7, 7, __pyx_nargs); __PYX_ERR(0, 41, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
  ...
  __Pyx_AddTraceback("pylablib.devices.Andor.utils.copyframes", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_8pylablib_7devices_5Andor_5utils_2copyframes(__pyx_self, __pyx_v_nbuff, __pyx_v_hbuffers, __pyx_v_size, __pyx_v_start, __pyx_v_ncpy, __pyx_v_off, __pyx_v_dst);
...
static PyObject *__pyx_pf_8pylablib_7devices_5Andor_5utils_2copyframes(CYTHON_UNUSED PyObject *__pyx_self, unsigned int __pyx_v_nbuff, size_t __pyx_v_hbuffers, unsigned int __pyx_v_size, unsigned int __pyx_v_start, unsigned int __pyx_v_ncpy, unsigned int __pyx_v_off, size_t __pyx_v_dst) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("copyframes", 0);

  /* "pylablib/devices/Andor/utils.pyx":42
 * 
 * def copyframes(unsigned nbuff, size_t hbuffers, unsigned size, unsigned start, unsigned ncpy, unsigned off, size_t dst):
 *     with nogil:             # <<<<<<<<<<<<<<
 *         ccopyframes(nbuff,<char**>hbuffers,size,start,ncpy,off,<char*>dst)
*/
  {
      ...
      /*try:*/ {
        ...
        /* "pylablib/devices/Andor/utils.pyx":43
 * def copyframes(unsigned nbuff, size_t hbuffers, unsigned size, unsigned start, unsigned ncpy, unsigned off, size_t dst):
 *     with nogil:
 *         ccopyframes(nbuff,<char**>hbuffers,size,start,ncpy,off,<char*>dst)             # <<<<<<<<<<<<<<
*/
        __pyx_t_1 = __pyx_f_8pylablib_7devices_5Andor_5utils_ccopyframes(__pyx_v_nbuff, ((char **)__pyx_v_hbuffers), __pyx_v_size, __pyx_v_start, __pyx_v_ncpy, __pyx_v_off, ((char *)__pyx_v_dst)); if (unlikely(__pyx_t_1 == ((int)-1) && __Pyx_ErrOccurredWithGIL())) __PYX_ERR(0, 43, __pyx_L4_error)
      }
...
__Pyx_RefNannySetupContext("PyInit_utils", 0);
  ...
  if (__pyx_module_is_main_pylablib__devices__Andor__utils) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pylablib.devices.Andor.utils")) {
      if (unlikely((PyDict_SetItemString(modules, "pylablib.devices.Andor.utils", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 *     cdef int result=0
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_8pylablib_7devices_5Andor_5utils_1looper, 0, __pyx_mstate_global->__pyx_n_u_looper, NULL, __pyx_mstate_global->__pyx_n_u_pylablib_devices_Andor_utils, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 25, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_looper, __pyx_t_2) < (0)) __PYX_ERR(0, 25, __pyx_L1_error)
 ...
 *         ccopyframes(nbuff,<char**>hbuffers,size,start,ncpy,off,<char*>dst)
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_8pylablib_7devices_5Andor_5utils_3copyframes, 0, __pyx_mstate_global->__pyx_n_u_copyframes, NULL, __pyx_mstate_global->__pyx_n_u_pylablib_devices_Andor_utils, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[1])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 41, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_copyframes, __pyx_t_2) < (0)) __PYX_ERR(0, 41, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "pylablib/devices/Andor/utils.pyx":1
 * import cython             # <<<<<<<<<<<<<<
 * from libc.string cimport memcpy
 * 
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init pylablib.devices.Andor.utils", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init pylablib.devices.Andor.utils");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } index[] = {{1},{9},{14},{13},{4},{20},{18},{18},{10},{3},{5},{8},{8},{13},{5},{6},{7},{8},{10},{8},{5},{4},{5},{3},{3},{28},{12},{6},{6},{12},{10},{4},{5},{8},{6},{28},{54}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (371 bytes) */
const char* const cstring = "BZh91AY&SY\340\2649\253\000\000\022\377\377ex\214\200\004\3416 \275At\206\277\357\377\360@@@@@@@@@@@@@\0000\001\rb\rT\366\224\3324Sz\243i\244=M4\r4\000=@d=\010y\246iPj\247\352O\311&\365\rOD\312\030 hd\030&\000\000\206\2005O%214\365\000i\220\000\000db\000\000\0038\326\016\027\0204\t\202\346\t#\302nx\331_\231ls\345\204\260\031\237'<\237M\351;\363\323%I\3515\027\312\r\020l@U'\254\020\354C\304\301\307\241\270K\221\003X \315\004\024X\243\247$v\352s\327z9l\034t\266k\032\260W\310\260\335?$J\332JcB\344\317\271D(\275\034\373\312k\242l\343\360\2378\020*\254`\202\363\264\341\025\004\001\317\017\031\332R\326\371p\235\022\210\232cH\344\007$T\354\233\354\251\324\030\rH\014p\240y\250\031\014\274\374\251\000eU\320\016\201,\206A\300\304$\020\353\264\033\204\317\364\251\240*\205\020ltB\202V\274 *D\375\246\252\316\302&\024\324\000\205\032\201=7\nC\026\314Wc\240fc*\253\200'\267 \300\200X\302Y^\255~\336\260Q\360\332V49\366\305\211\357<\007\351es\230\250\340\217\361w$S\205\t\016\013C\232\260";
    PyObject *data = __Pyx_DecompressString(cstring, 371, 2);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #elif (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (317 bytes) */
const char* const cstring = "x\332=\217=K\003A\020\206\t\004\211ZX\030\360\017\010js\020\321\302J\242\022\254B\014\202Md\330\333\235\323\305\275\335\313~$9\253\224)\257L\231\3222e\312\224\226)\257\364\2478\227\210\013\36323;\3630\357m\360R\271(\313'\355gx\n\030\360.$\tZ\252^\230\364\273\342Q\013\005\320\313'\024\017\222{\350\342\304\3671a.\327\\\232\210\033k\210\243\321qE\nR\203\267\214c\314\370\0077Y\236X\226\242\023\316\243\223\237\010\220\004\315\001\336\343-\334\201t\360O\220\036S\247\214\311\320V*\365\033@\312\010H/5\"(\2542M<\322\n\240y\226k\213L\230$\311L\226\345\212\305J\306\221\300\221\344\350\242\266\026\306F[\227\000\303\300\324nwXY\025\026]P\036\300\241\377cR&\310\030u\253S\235g\226\276\351n\322\021S\001\335\264V\356\037\224\215\343\242Ut\346\347\213\213\257\353\345\336\022WW\253\361\232Mk?\365f\321\336\016\034\315\306\005+\302\274C#7\313\316\352l}\362\335\330\364\006\233\301k\331<]t7\227\367\353VY?\234\265~\001\016\340\234\356";
    PyObject *data = __Pyx_DecompressString(cstring, 317, 1);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (387 bytes) */
const char* const bytes = "?utils.pyxAT_QueueBufferAT_WaitBufferHndl__Pyx_PyDict_NextRefasyncio.coroutinescline_in_tracebackcopyframesdstesize__func__hbuffers_is_coroutineitemslooperlooping__main____module____name__nbuffncpynreadoffpoppylablib.devices.Andor.utils__qualname__queuedresult__set_name__setdefaultsizestart__test__values\200\001\330\t\n\330\010\023\2201\220F\230(\240)\2505\260\006\260e\2704\270w\300a\200\001\340\004\024\220A\330\t\n\330\010\017\210w\220a\220u\230F\240)\2509\260F\270'\300\027\310\010\320P\\\320\\]\330\024$\240N\3202C\3001\330\004\013\2101";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  {
    const __Pyx_PyCode_New_function_description descr = {9, 0, 0, 10, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 25};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_Hndl, __pyx_mstate->__pyx_n_u_nbuff, __pyx_mstate->__pyx_n_u_hbuffers, __pyx_mstate->__pyx_n_u_esize, __pyx_mstate->__pyx_n_u_queued, __pyx_mstate->__pyx_n_u_looping, __pyx_mstate->__pyx_n_u_nread, __pyx_mstate->__pyx_n_u_AT_WaitBuffer, __pyx_mstate->__pyx_n_u_AT_QueueBuffer, __pyx_mstate->__pyx_n_u_result};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_utils_pyx, __pyx_mstate->__pyx_n_u_looper, __pyx_mstate->__pyx_kp_b_iso88591_A_wauF_9F_P_N2C1_1, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
  {
    const __Pyx_PyCode_New_function_description descr = {7, 0, 0, 7, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 41};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_nbuff, __pyx_mstate->__pyx_n_u_hbuffers, __pyx_mstate->__pyx_n_u_size, __pyx_mstate->__pyx_n_u_start, __pyx_mstate->__pyx_n_u_ncpy, __pyx_mstate->__pyx_n_u_off, __pyx_mstate->__pyx_n_u_dst};
    __pyx_mstate_global->__pyx_codeobj_tab[1] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_utils_pyx, __pyx_mstate->__pyx_n_u_copyframes, __pyx_mstate->__pyx_kp_b_iso88591_1F_5_e4wa, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[1])) goto bad;
  }
